...
type BasketballRouter struct {
	beego.Controller
}

func (this *BasketballRouter) Get() {
	// Set const
	this.Data["App_Name"] = App_Name

	this.Data["IsBasketball"] = true
	...
	all := models.AllBasketball()
	var AllBasket []Game

	for _, v := range all {
		// Check if game is over
		if v.Isover == 1 {
			AllBasket = append(AllBasket, Game{
				Game_Detail: v,
	...
	this.Data["AllGame"] = AllBasket

	this.TplNames = "basketball.html"
}
